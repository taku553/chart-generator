          ...
          <div className="space-y-4">
            ...
            <div className={`flex items-start space-x-3 rounded-lg border-2 p-4 transition-colors ${
              ...
              <div className="flex-1">
                ...
                >
                  {t('parentheses.optionPositive')}
                </Label>
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                  {t('parentheses.previewOriginal')}: {examples[0]}
                </p>
                <div className="mt-2 text-sm">
                  <span className="text-gray-500">{t('parentheses.previewConverted')}: </span>
                  {examples[0] && (
                    <span className="font-mono">
                      {getPreviewValue(examples[0], 'positive')}
                    </span>
                  )}
                </div>
              </div>
            ...
            <div className={`flex items-start space-x-3 rounded-lg border-2 p-4 transition-colors ${
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 text-sm">
                  ...
                  {examples[0] && (
                    <span className="font-mono">
                      {getPreviewValue(examples[0], 'negative')}
                    </span>
                  )}
                </div>
              </div>
        ...
        {examples.length > 0 && (
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
            <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">
              {t('parentheses.previewTitle')}
            </h4>
            <div className="space-y-2 text-sm">
              {examples.slice(0, 2).map((example, index) => (
                <div key={index} className="flex items-center gap-2">
                  <span className="text-gray-500">{t('parentheses.previewOriginal')}:</span>
